...
var fetchMapFeatures = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    var geo_url, seg_ids, resp, features, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, feat, feat_filtered, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _feat;

    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            geo_url = API_SERVER + GEO_VIEW + '?select=geometry,cmp_segid,cmp_name,cmp_from,cmp_to,direction,length,cls_hcm85';
            _context2.prev = 1;

            // get a list of valid CMPs
            seg_ids = [];
            _context2.next = 5;
            return fetch(API_SERVER + DATA_VIEW + '?select=cmp_segid');
          ...
          case 28:
            seg_ids = (0, _from2.default)(new _set2.default(seg_ids));
          ...
          case 34:
            ...
            for (_iterator2 = (0, _getIterator3.default)(features); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              ...
              if (seg_ids.includes(_feat.cmp_segid)) {
                _feat['type'] = 'Feature';
...
var fetchAggregateData = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var buildAggData, url, resp, jsonData, vizData, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, tod, _loop, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, scn;
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            buildAggData = {};
            url = API_SERVER + AGGDATA_VIEW + '?select=fac_typ,period,scenario,viz,metric';
            _context3.prev = 2;
            _context3.next = 5;
            return fetch(url);
          ...
          case 8:
            ...
            for (_iterator3 = (0, _getIterator3.default)(app.time_options); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              tod = _step3.value;
          ...
          case 29:
            _loop = function _loop(scn) {
              var _loop2 = function _loop2(_tod) {
                var row = {};
                row[YR_VAR] = scn.toString();
                row['Arterial'] = Math.round(vizData.filter(function (row) {
                  return row[YR_VAR] == scn && row[TOD_VAR] == _tod.value && row['fac_typ'] == 'Arterial';
                })[0]['metric'] * 10) / 10;
                row['Freeway'] = Math.round(vizData.filter(function (row) {
                  return row[YR_VAR] == scn && row[TOD_VAR] == _tod.value && row['fac_typ'] == 'Freeway';
                })[0]['metric'] * 10) / 10;
                buildAggData[_tod.value].push(row);
              };
              ...
              try {
                for (var _iterator5 = (0, _getIterator3.default)(app.time_options), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                  var _tod = _step5.value;
            ...
            _context3.prev = 33;
            for (_iterator4 = (0, _getIterator3.default)(SCNYR_LIST); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              scn = _step4.value;
          ...
          case 49:
            return _context3.abrupt('return', buildAggData);

          case 52:
            _context3.prev = 52;
            _context3.t2 = _context3['catch'](2);

            console.log('aggregate data error: ' + _context3.t2);
    ...
    }, _callee3, this, [[2, 52], [13, 17, 21, 29], [22,, 24, 28], [33, 37, 41, 49], [42,, 44, 48]]);
  }));
...
var getMapData = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
    var data_url, resp, jsonData, tmp, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, scn, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, tod, _iteratorNormalCompletion9, _didIteratorError9, _iteratorError9, _iterator9, _step9, met, _loop3, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, entry;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 14:
            ...
            _context4.prev = 21;
            _iterator8 = (0, _getIterator3.default)(app.time_options);
          ...
          case 86:
            _loop3 = function _loop3(entry) {
              ...
              try {
                for (var _iterator10 = (0, _getIterator3.default)(app.metric_options), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                  var _met = _step10.value;
              ...
              var facility = 'Arterial';
              var feat = _featJson.filter(function (rec) {
                return rec[GEOID_VAR] == entry[GEOID_VAR];
              })[0];
            ...
            for (_iterator7 = (0, _getIterator3.default)(jsonData); !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              entry = _step7.value;
    ...
    }, _callee4, this, [[12, 74, 78, 86], [21, 57, 61, 69], [30, 34, 38, 46], [39,, 41, 45], [62,, 64, 68], [79,, 81, 85], [90, 94, 98, 106], [99,, 101, 105]]);
  }));
...
var drawMapFeatures = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
    ...
    var cleanFeatures, sel_metric, base_scnyr, comp_scnyr, map_metric, bwidth_metric, _iteratorNormalCompletion11, _didIteratorError11, _iteratorError11, _iterator11, _step11, feat, color_func, sel_colorvals2, bp, dist_vals, x, numticks, histogram, mode, custom_bps, i, bw_widths, _iteratorNormalCompletion12, _didIteratorError12, _iteratorError12, _iterator12, _step12, _feat2, _iteratorNormalCompletion13, _didIteratorError13, _iteratorError13, _iterator13, _step13, _i;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 38:
            ...
            _context5.prev = 49;
            _iterator12 = (0, _getIterator3.default)(cleanFeatures);
          ...
          case 94:
            _context5.prev = 94;
            _context5.t2 = _context5['catch'](90);
    ...
    }, _callee5, this, [[8, 126], [20, 24, 28, 36], [29,, 31, 35], [49, 74, 78, 86], [79,, 81, 85], [90, 94, 98, 106], [99,, 101, 105]]);
  }));
...
var DATA_VIEW = 'cmpqa_2019';
var AGGDATA_VIEW = 'cmpqa_aggregate';

var GEOTYPE = 'Segment';
var GEOID_VAR = 'cmp_segid';
var YR_VAR = 'scenario';
var TOD_VAR = 'period';

var FRAC_COLS = ['avg_speed'];
var SCNYR_LIST = ['2017-off', '2017-tmc', '2017-npm', '2017-xd', '2019-npm', '2019-xd'];
...
var METRIC_UNITS = { 'avg_speed': 'mph' };
...
function getInfoHtml(geo) {
  ...
  var ftype = geo.cls_hcm85 == 'Fwy' ? 'Freeway' : 'Arterial';
  var retval = '<b>SEGID: </b>' + (geo[GEOID_VAR] + '<br/>') + '<b>FACILITY TYPE: </b>' + (ftype + '<br/>') + '<b>STREET: </b>' + (geo.cmp_name + '<br/>') + '<b>DIRECTION: </b>' + (geo.direction + '<br/>') + '<b>FROM: </b>' + (geo.cmp_from + '<br/>') + '<b>TO: </b>' + (geo.cmp_to + '<br/><hr>');
  if (app.comp_check) {
...
function updateDistChart(bins) {
  ...
  try {
    for (var _iterator14 = (0, _getIterator3.default)(bins), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
      var b = _step14.value;
...
function buildChartHtmlFromData() {
  ...
  if (geoid) {
    ...
    try {
      for (var _iterator15 = (0, _getIterator3.default)(SCNYR_LIST), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
        var scn = _step15.value;
...
var app = new Vue({
  ...
  data: {
    ...
    metric_options: [{ text: 'avg_speed', value: 'avg_speed' }],
    ...
    selected_timep: 'AM',
    time_options: [{ text: 'AM', value: 'AM' }, { text: 'PM', value: 'PM' }],
