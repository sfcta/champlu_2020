      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 45:
            ...
            _context5.prev = 49;
            for (_iterator12 = (0, _getIterator3.default)(sel_colorvals); !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              i = _step12.value;
...
var selectionChanged = function () {
  ...
  return function selectionChanged(_x2) {
...
var postComments = function () {
  ...
  return function postComments(_x3) {
...
var METRIC_DESC = { 'auto': 'Auto Jobs Accessible in 30 mins',
...
var COLORRAMP = { SEQ: ['#eaf8f8', '#d3f1f0', '#b5e8e6', '#8edcd8', '#69d0cc', '#47c6c1', '#31bfb9', '#26a4a3', '#1b888b'],
...
var CUSTOM_BP_DICT = {
  ...
  'auto': { '2015': [100, 300, 500, 700, 900, 1000, 1100, 1200],
    ...
    'diff': [-300, -100, 100, 300, 500, 700, 900, 1000, 1100, 1200] }
  // legend info
};var METRIC_UNITS = { 'auto': '000s',
  'transit': '000s' };
var METRIC_DESC_SHORT = { 'auto': 'Jobs Accessible',
...
function getInfoHtml(geo) {
  ...
  retval += '<b>' + YR_LIST[0] + '</b> ' + ('<b>' + METRIC_DESC[app.selected_metric] + ': </b>') + (metric1 + '<br/>') + ('<b>' + YR_LIST[1] + '</b> ') + ('<b>' + METRIC_DESC[app.selected_metric] + ': </b>') + (metric2 + '<br/>') + ('<b>' + METRIC_DESC[app.selected_metric] + '</b>') + '<b> Change: </b>' + ('' + diff);
  return retval;
}
...
var app = new Vue({
  ...
  data: {
    ...
    metric_options: [{ text: 'Auto', value: 'auto' }, { text: 'Transit', value: 'transit' }],
    ...
    // data view 
    aggData: [{ auto: 0, transit: 0 }, { auto: 0, transit: 0 }],
