...
var $export = __webpack_require__(52);
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !__webpack_require__(53), 'Object', { defineProperty: __webpack_require__(54).f });
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            geo_url = API_SERVER + scenario_list[1] + '?select=geometry,a,b,streetname' + '&' + 'time_period=eq.AM' + '&' + ft_filter;
            _context2.prev = 1;
            _context2.next = 4;
...
var fetchScenarios = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var data_url, scnlist, resp, parsedJson, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, obj;

    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            data_url = API_SERVER + SCENARIO_VIEW;
            scnlist = [];
            _context3.prev = 2;
            _context3.next = 5;
          ...
          case 8:
            parsedJson = _context3.sent;
            _iteratorNormalCompletion2 = true;
            _didIteratorError2 = false;
            _iteratorError2 = undefined;
            _context3.prev = 12;

            for (_iterator2 = (0, _getIterator3.default)(parsedJson); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              obj = _step2.value;
          ...
          case 28:
            return _context3.abrupt('return', scnlist);

          case 31:
            _context3.prev = 31;
            _context3.t1 = _context3['catch'](2);
            console.log('scenario data fetch error: ' + _context3.t1);
          case 34:
          case 'end':
            return _context3.stop();
        }
      }
    }, _callee3, this, [[2, 31], [12, 16, 20, 28], [21,, 23, 27]]);
  }));

  return function fetchScenarios() {
...
var getMapData = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(view) {
    var data_url, resp, jsonData, lookup, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, entry;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            data_url = API_SERVER + view + '?select=a,b,' + app.selected_metric + ',' + app.selected_bwidth + '&time_period=eq.' + app.selected_timep + '&' + ft_filter;
          ...
          case 7:
            ...
            for (_iterator3 = (0, _getIterator3.default)(jsonData); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              entry = _step3.value;
          ...
          case 28:
            return _context4.abrupt('return', lookup);
...
var drawMapFeatures = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
    ...
    var cleanFeatures, sel_metric, map_metric, bwidth_metric, baseVal, compVal, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, feat, color_func, sel_colorvals2, bp, x, numticks, histogram, mode, custom_bps, i, bw_widths, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _feat, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _i;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 9;
            return getMapData(app.selected_base_scenario);

          case 9:
            base_lookup = _context5.sent;
            _context5.next = 12;
            return getMapData(app.selected_comp_scenario);

          case 12:
            comp_lookup = _context5.sent;
            map_metric = void 0;
            ...
            _context5.prev = 22;
            for (_iterator4 = (0, _getIterator3.default)(cleanFeatures); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              feat = _step4.value;
          ...
          case 40:
            ...
            if (queryMapData) {
              ...
              x = d3.scaleLinear().domain([map_vals[0], map_vals[map_vals.length - 1]]);
              numticks = 20;
            ...
            _context5.prev = 51;
            _iterator5 = (0, _getIterator3.default)(cleanFeatures);
          ...
          case 88:
            ...
            _context5.prev = 92;
            for (_iterator6 = (0, _getIterator3.default)(sel_colorvals2); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
              _i = _step6.value;
          ...
          case 96:
            _context5.prev = 96;
            _context5.t2 = _context5['catch'](92);
          ...
          case 108:
            ...
            mapLegend.onAdd = function (map) {
              ...
              legHTML = '<h4>' + sel_metric.toUpperCase() + (METRIC_UNITS.hasOwnProperty(sel_metric) ? ' (' + METRIC_UNITS[sel_metric] + ')' : '') + '</h4>' + legHTML;
              if (app.bwidth_check) {
    ...
    }, _callee5, this, [[4, 117], [22, 26, 30, 38], [31,, 33, 37], [51, 76, 80, 88], [81,, 83, 87], [92, 96, 100, 108], [101,, 103, 107]]);
  }));
...
var getMetricOptions = function () {
  ...
  return function getMetricOptions() {
...
var SCENARIO_VIEW = 'tables_hwynet';
var EXCLUDE_COLS = ['a', 'b', 'streetname', 'type', 'mtype', 'time_period', 'distance', 'at', 'ft'];
var FRAC_COLS = ['v_1', 'vdt_1', 'cspd_1', 'vc_1'];
var INT_COLS = ['dt', 'at', 'ft2'];
...
var METRIC_UNITS = { 'speed': 'mph', 'inrix_speed': 'mph' };

var sel_colorvals = void 0,
    sel_colors = void 0,
    sel_binsflag = void 0;
var sel_bwvals = void 0;
var init_selected_metric = 'cspd_1';
var metric_options_all = void 0,
    metric_options_daily = void 0;
var daily_metric_list = ['v_1', 'vdt_1', 'cspd_1', 'vc_1'];
var bwidth_metric_list = ['v_1'];
var time_period = ['DAILY', 'AM', 'EA', 'EV', 'MD', 'PM'];
var scenario_list = void 0;
...
var ft_filter = 'ft=neq.6&ft=neq.11&ft=lt.13&mtype=eq.SF';
...
infoPanel.update = function (geo) {
  ...
  if (geo) {
    this._div.innerHTML = '<b>A_B</b><b>: </b>' + geo.a + ('_' + geo.a + '<br/>') + ('<b>STREETNAME</b><b>: </b>' + geo.streetname + '<br/>') + ('<b>' + app.selected_metric.toUpperCase() + '</b><b>: </b>' + metric_val) + (app.bwidth_check ? '<br/><b>' + app.selected_bwidth.toUpperCase() + '</b>' + '<b>: </b>' + bwmetric_val : '');
  }
...
function hoverFeature(e) {
  ...
  if (oldHoverTarget && e.target.feature.a + '_' + e.target.feature.b != selGeoId) {
    if (oldHoverTarget.feature.a + '_' + oldHoverTarget.feature.b != selGeoId) geoLayer.resetStyle(oldHoverTarget);
  }
...
function updateDistChart(bins) {
  ...
  try {
    for (var _iterator7 = (0, _getIterator3.default)(bins), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      var b = _step7.value;
...
function showSegmentDetails(geo, latlng) {
  ...
  if (geo) {
    // show popup
    popupText = '<b>' + app.selected_metric.toUpperCase() + '</b><b>: </b>' + metric_val + (app.bwidth_check ? '<br/><b>' + app.selected_bwidth.toUpperCase() + '</b>' + '<b>: </b>' + bwmetric_val : '');
  }
...
function fillOptions(options) {
  ...
  try {
    for (var _iterator8 = (0, _getIterator3.default)(options), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
...
var app = new Vue({
  ...
  data: (_data = {
    ...
    scenario_options: [{ text: '', value: '' }],

    selected_comp_scenario: null
  }, (0, _defineProperty3.default)(_data, 'scenario_options', [{ text: '', value: '' }]), (0, _defineProperty3.default)(_data, 'selected_metric', ''), (0, _defineProperty3.default)(_data, 'metric_options', [{ text: '', value: '' }]), (0, _defineProperty3.default)(_data, 'selected_bwidth', bwidth_metric_list[0]), (0, _defineProperty3.default)(_data, 'bwidth_options', []), (0, _defineProperty3.default)(_data, 'selected_colorscheme', ['#d7191c', '#fdae61', '#ffffbf', '#a6d96a', '#1a9641']), (0, _defineProperty3.default)(_data, 'color_options', [{ text: 'Cream-Purple', value: ['#ffffcc', '#3f324f'] }, { text: 'Purple-Cream', value: ['#3f324f', '#ffffcc'] }, { text: 'GnYlRd', value: ['#1a9641', '#a6d96a', '#ffffbf', '#fdae61', '#d7191c'] }, { text: 'RdYlGn', value: ['#d7191c', '#fdae61', '#ffffbf', '#a6d96a', '#1a9641'] }, { text: 'YlOrRd', value: 'YlOrRd' }, { text: 'Yellow-Blue', value: ['#fafa6e', '#2A4858'] }, { text: 'YlRdBl', value: ['Yellow', 'Red', 'Black'] }, { text: 'Spectral', value: 'Spectral' }, { text: 'YlGn', value: 'YlGn' }]), (0, _defineProperty3.default)(_data, 'modeMap', {
    '#ffffcc,#663399': 'lch',
    '#ebbe5e,#3f324f': 'hsl',
    '#ffffcc,#3f324f': 'hsl',
    '#3f324f,#ffffcc': 'hsl',
    '#fafa6e,#2A4858': 'lch'
  }), (0, _defineProperty3.default)(_data, 'selected_breaks', 5), (0, _defineProperty3.default)(_data, 'break_options', [{ text: 'Tertiles (3)', value: 3 }, { text: 'Quartiles (4)', value: 4 }, { text: 'Quintiles (5)', value: 5 }]), _data),
  watch: {
...
var _defineProperty = __webpack_require__(453);
