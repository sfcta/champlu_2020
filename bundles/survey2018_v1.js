      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            retval['text'] = trec['trip_num'] + ', ' + PURP_MAP[trec['o_purpose_category']] + ', ' + PURP_MAP[trec['d_purpose_category']] + ', ' + MODE_MAP[trec['mode_type']] + ', ' + trec['depart_time'].substring(11, 19) + ', ' + trec['arrive_time'].substring(11, 19);
...
var HH_VIEW = 'household_v1';
var PERSON_VIEW = 'person_v1';
var TRIP_VIEW = 'trip_v1';
var LOCATION_VIEW = 'location_v1';
